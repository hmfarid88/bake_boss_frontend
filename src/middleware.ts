...
const roleRouteMap: Record<UserRole, string[]> = {
  ...
  ROLE_PRODUCTION: [
    ...
    '/dashboard',
    '/datewise-dp-dist',
    '/datewise-fancy-materials',
    '/materials-dist-report',
    '/datewise-materials-dist-report',
    '/datewise-materials-ledger',
    '/datewise-packaging-materials',
    '/datewise-purchase-ledger',
    '/datewise-production-materials',
    '/datewise-profit-report',
    '/datewise-staff-consumed',
  ...
  ROLE_MANAGEMENT: ['/datewise-management-dist-report',
    '/datewise-management-profit',
    '/datewise-management-sale',
    '/management-dashboard',
    '/management-dist-report',
    '/management-outlet-stock',
    '/management-profit',
  ...
  ROLE_MATERIALS: ['/datewise-management-dist-report',
    '/add-damage',
    '/add-distribution',
    '/add-materials',
    '/damaged-materials',
    '/datewise-dist-report',
    '/datewise-material-ledger',
    '/datewise-purse-ledger',
    '/dist-report',
    '/material-ledger',
    '/materials-cashbook',
    '/materials-dashboard',
  ...
  try {
    ...
    if (session?.username && session?.roles) {
      ...
      if (isPublicRoute) {
        ...
        if (
          session.roles === 'ROLE_MANAGEMENT' &&
          !req.nextUrl.pathname.startsWith('/management-dashboard')
        ) {
          return NextResponse.redirect(new URL('/management-dashboard', req.nextUrl));
        }
        if (
          session.roles === 'ROLE_MATERIALS' &&
          !req.nextUrl.pathname.startsWith('/materials-dashboard')
        ) {
          return NextResponse.redirect(new URL('/materials-dashboard', req.nextUrl));
        }
      }
    }
  } catch (error) {
