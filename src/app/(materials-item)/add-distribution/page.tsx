...
const Page: React.FC = () => {
    ...
    const handleProductSubmit = async (e: any) => {
        ...
        try {
            const response = await fetch(`${apiBaseUrl}/api/getRawSingleMaterial?materialsId=${selectedProid}`);
            if (!response.ok) {
    ...
    const handleFinalSubmit = async (e: any) => {
        ...
        setPending(true);
        try {
            const response = await fetch(`${apiBaseUrl}/api/rawMaterialSale`, {
                method: 'POST',
                headers: {
        ...
        <div className='container-2xl min-h-screen'>
            <div className="flex flex-col">
                ...
                <div className="flex flex-col w-full">
                    <div className="divider divider-accent tracking-widest font-bold p-5">MATERIAL DISTRIBUTION</div>
                </div>
