...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getDatewiseOfficePay?username=${username}&startDate=${startDate}&endDate=${endDate}`)
            ...
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                ...
                <div className="overflow-x-auto">
                    <div ref={contentToPrint} className="flex-1 p-5">
                        <div className="flex flex-col items-center pb-5"><h4 className="font-bold">OFFICE PAYMENT REPORT</h4>
