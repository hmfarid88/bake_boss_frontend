...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/paymentApi/getOfficePay?username=${username}`)
        ...
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                ...
                <div className="flex w-full justify-between p-5">
                    ...
                    <DateToDate routePath="/datewise-officepay-report" />
                    <button onClick={handlePrint} className='btn btn-ghost btn-square'><FcPrint size={36} /></button>
                </div>
                <div ref={contentToPrint} className="flex-1 p-5">
                    <div className="flex flex-col items-center pb-5"><h4 className="font-bold">OFFICE PAYMENT REPORT</h4><CurrentMonthYear /></div>
