...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/api/getMonthlySoldMaterials?username=${username}`)
    ...
    const totalValue = filteredProducts.reduce((total, product) => {
        return total + product.materialsQty * product.averageRate;
    }, 0);

    return (
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                <div className="flex w-full justify-center p-5"><DateToDate routePath="/datewise-materials-dist-report" /></div>
                            ...
                            <tbody>
                                {filteredProducts?.map((product, index) => (
                                    <tr key={index} className="capitalize">
                                        ...
                                        <td className="uppercase">{product.madeItem}</td>
