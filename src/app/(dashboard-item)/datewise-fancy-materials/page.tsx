...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/api/getDatewiseFancyMaterial?username=${username}&startDate=${startDate}&endDate=${endDate}`)
        ...
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                <div className="flex justify-center items-center gap-2 mb-5">
                    <DateToDate routePath="/datewise-fancy-materials" />
                </div>
                ...
                <div className="overflow-x-auto">
                    <div ref={contentToPrint} className="flex-1 p-5">
                        <div className="flex flex-col items-center pb-5"><h4 className="font-bold">FANCY MATERIALS</h4>
