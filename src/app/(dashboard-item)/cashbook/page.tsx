...
const Page = () => {
  ...
  useEffect(() => {
    fetch(`${apiBaseUrl}/paymentApi/net-sum-before-today?username=${username}`)
  ...
  useEffect(() => {
    fetch(`${apiBaseUrl}/paymentApi/payments/today?username=${username}`)
      .then(response => response.json())
  ...
  useEffect(() => {
    fetch(`${apiBaseUrl}/paymentApi/receives/today?username=${username}`)
      .then(response => response.json())
