...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/api/getDatewisePackagingMaterial?username=${username}&startDate=${startDate}&endDate=${endDate}`)
    ...
    const totalValue = filteredProducts.reduce((total, product) => {
        return total + product.averageRate * product.materialsQty;
    }, 0);
        ...
        <div className="container-2xl">
            <div className="flex flex-col w-full min-h-[calc(100vh-228px)] p-4 items-center justify-center">
                <div className="flex justify-center items-center gap-2 mb-5">
                    <DateToDate routePath="/datewise-packaging-materials" />
                </div>
                ...
                <div className="overflow-x-auto">
                    <div ref={contentToPrint} className="flex-1 p-5">
                        <div className="flex flex-col items-center pb-5"><h4 className="font-bold">PACKAGING MATERIALS</h4>
                            ...
                            <tbody>
                                {filteredProducts?.map((product, index) => (
                                    <tr key={index} className="capitalize">
                                        ...
                                        <td>{Number((product.averageRate * product.materialsQty).toFixed(2)).toLocaleString('en-IN')}</td>
                                    </tr>
                                ))}
                            </tbody>
                            <tfoot>
