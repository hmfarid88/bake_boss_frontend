...
const DetailsSupplier = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/supplierBalance/supplier/details?username=${username}&supplierName=${supplierName}&startDate=${startDate}&endDate=${endDate}`)
