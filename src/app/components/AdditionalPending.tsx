...
const AdditionalPending = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${apiBaseUrl}/sales/pendingAdditionalStock?customer=${username}`)
    ...
    const handleDetails = (invoiceNo: string) => {
        router.push(`/pending-additional-details?invoiceNo=${encodeURIComponent(invoiceNo)}`);
    }
                    ...
                    <tbody>
                        {filteredProducts?.map((product, index) => (
                            <tr key={index}>
                                ...
                                <td><button onClick={() => handleDetails(product.invoiceNo)} className="btn btn-success btn-sm">Details</button></td>
                            </tr>
                        ))}
                    </tbody>
                    <tfoot>
...
export default AdditionalPending